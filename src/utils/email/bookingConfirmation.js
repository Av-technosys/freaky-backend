export const bookingConfirmed = ({ bookingId, name, services, date, time, location }) => {
  return `
...
<p style="
  ...
  padding: 0 12px;
">
  Hi ${name}, your booking is confirmed and everything is set for your event.
</p>
...
">
  ...
  <div style="font-size:15px; line-height:1.9; color:#1f2937;">
    ...
    <div style="display:flex; margin-bottom:6px; width:100%;">
      ...
      <div style="text-align: end; width:100%;">#FC-${bookingId}</div>
    </div>

    <div style="display:flex; margin-bottom:6px;">
      <div style="width:186px; font-weight:bold;">Name:</div>
      <div style="text-align: end; width:100%;">${name}</div>
    </div>

    <div style="display:flex; margin-bottom:6px;">
      <div style="width:186px; font-weight:bold;">Service / Product:</div>
      <div style="text-align: end; width:100%;">${services}</div>
    </div>

    <div style="display:flex; margin-bottom:6px;">
      <div style="width:186px; font-weight:bold;">Date:</div>
      <div style="text-align: end; width:100%;">${date}</div>
    </div>

    <div style="display:flex; margin-bottom:6px;">
      <div style="width:186px; font-weight:bold;">Time:</div>
      <div style="text-align: end; width:100%;">${time}</div>
    </div>

    <div style="display:flex; margin-bottom:6px;">
      <div style="width:186px; font-weight:bold;">Location:</div>
      <div style="text-align: end; width:100%;">${location}</div>
    </div>

    <div style="display:flex;">
      <div style="width:186px; font-weight:bold;">Payment Status:</div>
      <div style="text-align: end; width:100%; color:#16a34a; font-weight:bold;">
        Paid ✅
      </div>
    </div>
