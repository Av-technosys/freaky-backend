export const paymentConfirmation = ({ bookingId, name, services, date, time, location, paymentMethod }) => {
  return `
...
<p style="
  ...
  padding: 0 14px;
">
  Payment Confirmed! Thanks, ${name} — we’ve received your payment for this booking.
</p>
