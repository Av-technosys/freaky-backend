    ...
    <div style="margin-bottom:14px;">
       ...
       <!-- Heading -->
        ...
        <p style="
          ...
          padding: 0 14px;
        ">
            We’re happy to inform you that a payment has been successfully received for a recent booking. Below are the
          ...
          ">
            ...
            <div style="font-size: 15px; line-height: 1.9; color: #1f2937">
                ...
                <div style="display: flex; margin-bottom: 6px">
                    ...
                    <div style="text-align: right; width: 100%">UPI</div>
                </div>
