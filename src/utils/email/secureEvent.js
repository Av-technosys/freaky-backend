...
export const secureEvent = () => {
  return `
    ${MAIL_HEAD}

     <!-- Welcome Image -->
    <div style="margin-bottom:14px;">
            <img src="https://freaky-files.s3.ap-south-1.amazonaws.com/email-media/secureEvent.png" alt="Welcome" style="width: 100%; max-width: 280px; height: auto" />
        </div>
